...
import { deleteEmployee } from '../employee.controller';




describe('Delete a member test cases', ()=>{
    let res:any
    ...
    //test cases
    it('Successfully deletes an employee', 
        ...
        async()=>{
            ...
            //Call the function
            await deleteEmployee(req as Request, res)
